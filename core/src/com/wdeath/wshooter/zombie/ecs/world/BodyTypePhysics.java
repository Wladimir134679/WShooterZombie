...
public class BodyTypePhysics {
    ...
    public static final short MASK_PLAYER = CATEGORY_WALL | CATEGORY_ZOMBIE | CATEGORY_SENSOR | CATEGORY_LIGHT;
    public static final short MASK_ZOMBIE = CATEGORY_WALL | CATEGORY_PLAYER | CATEGORY_BULLET | CATEGORY_LIGHT;
    public static final short MASK_BULLET = CATEGORY_WALL | CATEGORY_ZOMBIE | CATEGORY_LIGHT;
